...
class Test extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/StatisticsPage.ets(104:5)");
            Column.width('100%');
            Column.height('100%');
            if (!isInitialRender) {
                Column.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/StatisticsPage.ets(105:7)");
            Row.width('100%');
            Row.height('7%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/StatisticsPage.ets(106:9)");
            Image.height(32);
            Image.width(32);
            Image.margin(20);
            Image.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("pages/StatisticsPage.ets(113:9)");
            if (!isInitialRender) {
                Blank.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/StatisticsPage.ets(114:9)");
            Image.height(32);
            Image.width(32);
            Image.margin(20);
            Image.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("pages/StatisticsPage.ets(124:7)");
            Flex.width("100%");
            Flex.height('90%');
            Flex.padding(24);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/StatisticsPage.ets(129:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.debugLine("pages/StatisticsPage.ets(130:11)");
            Column.padding(5);
            Column.height('100%');
            Column.width('50%');
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('本月统计');
            Text.debugLine("pages/StatisticsPage.ets(131:13)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('支出');
            Text.debugLine("pages/StatisticsPage.ets(137:13)");
            Text.fontColor(Color.Black);
            Text.fontSize(22);
            Text.opacity(0.5);
            Text.alignSelf(ItemAlign.Start);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/StatisticsPage.ets(143:13)");
            Text.fontColor(Color.Black);
            Text.fontSize(34);
            Text.alignSelf(ItemAlign.Start);
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/StatisticsPage.ets(145:13)");
            Row.margin({
                top: 10
            });
            Row.height(32);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('收入');
            Text.debugLine("pages/StatisticsPage.ets(146:15)");
            Text.fontSize(18);
            Text.opacity(0.5);
            Text.fontColor(Color.Black);
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/StatisticsPage.ets(147:15)");
            Text.fontSize(18);
            Text.fontColor(Color.Black);
            if (!isInitialRender) {
                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Divider.create();
            Divider.debugLine("pages/StatisticsPage.ets(148:15)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('结余');
            Text.debugLine("pages/StatisticsPage.ets(154:15)");
            Text.fontSize(18);
            Text.opacity(0.5);
            Text.fontColor(Color.Black);
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/StatisticsPage.ets(155:15)");
            Text.fontSize(18);
            Text.fontColor(Color.Black);
            if (!isInitialRender) {
                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/StatisticsPage.ets(189:9)");
            Column.width('90%');
            Column.height(220);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Polyline.debugLine("pages/StatisticsPage.ets(191:11)");
            //          Stack() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/StatisticsPage.ets(220:9)");
            Column.padding(6);
            Column.width('90%');
            Column.height('180');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('今日');
            Text.debugLine("pages/StatisticsPage.ets(221:11)");
            Text.fontSize(23);
            if (!isInitialRender) {
                Text.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/StatisticsPage.ets(222:11)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/StatisticsPage.ets(223:13)");
            Column.width('50%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/StatisticsPage.ets(224:15)");
            Text.fontSize(26);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('收');
            Text.debugLine("pages/StatisticsPage.ets(230:15)");
            Text.width(78);
            Text.height(48);
            Text.margin(6);
            Text.fontSize(32);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/StatisticsPage.ets(248:13)");
            Column.width('50%');
            Column.borderRadius(28);
            Column.justifyContent(FlexAlign.SpaceAround);
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/StatisticsPage.ets(249:15)");
            Text.fontSize(26);
            Text.fontWeight(FontWeight.Bolder);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('支');
            Text.debugLine("pages/StatisticsPage.ets(255:15)");
            Text.width(78);
            Text.height(48);
            Text.margin(6);
            Text.fontSize(32);
