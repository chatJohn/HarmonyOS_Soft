...
class CategorySelectedAccountsPage extends ViewPU {
    ...
    itemHead(ele, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/CategorySelectedAccountsPage.ets(87:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CategorySelectedAccountsPage.ets(88:7)");
            Text.fontSize(20);
            Text.width("40%");
            Text.padding(10);
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("pages/CategorySelectedAccountsPage.ets(93:7)");
            Blank.width('10%');
            if (!isInitialRender) {
                Blank.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/CategorySelectedAccountsPage.ets(96:7)");
            Image.width('10%');
            Image.padding(10);
            if (!isInitialRender) {
                Image.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CategorySelectedAccountsPage.ets(100:7)");
            Text.fontSize(15);
            Text.width('15%');
            Text.padding(10);
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/CategorySelectedAccountsPage.ets(106:7)");
            Image.padding(10);
            Image.width('10%');
            if (!isInitialRender) {
                Image.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CategorySelectedAccountsPage.ets(111:7)");
            Text.fontSize(15);
            Text.width('15%');
            Text.padding(10);
            if (!isInitialRender) {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/CategorySelectedAccountsPage.ets(121:5)");
            ...
            Column.margin({ top: { "id": 16777237, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/CategorySelectedAccountsPage.ets(122:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777259, "type": 10003, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            Text.debugLine("pages/CategorySelectedAccountsPage.ets(123:9)");
            Text.height({ "id": 16777228, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            Text.fontSize({ "id": 16777238, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            Text.margin({ left: { "id": 16777238, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/CategorySelectedAccountsPage.ets(128:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Scroll.debugLine("pages/CategorySelectedAccountsPage.ets(145:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("pages/CategorySelectedAccountsPage.ets(146:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    ListItemGroup.debugLine("pages/CategorySelectedAccountsPage.ets(149:13)");
                    if (!isInitialRender) {
                        ListItemGroup.pop();
                    }
                    ViewStackProcessor.StopGetAccessRecording();
                    ...
                    const forEachItemGenFunction = _item => {
                        const item = _item;
                        {
                            ...
                            const itemCreation = (elmtId, isInitialRender) => {
                                ...
                                ListItem.debugLine("pages/CategorySelectedAccountsPage.ets(153:17)");
                                if (!isInitialRender) {
                                    ListItem.pop();
                                }
                                ViewStackProcessor.StopGetAccessRecording();
                            ...
                            const observedDeepRender = () => {
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Row.create();
                                    Row.debugLine("pages/CategorySelectedAccountsPage.ets(154:19)");
                                    Row.width(CommonConstants.FULL_WIDTH);
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("pages/CategorySelectedAccountsPage.ets(155:21)");
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Column.create();
                                    Column.debugLine("pages/CategorySelectedAccountsPage.ets(160:21)");
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("pages/CategorySelectedAccountsPage.ets(161:23)");
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Row.create();
                                    Row.debugLine("pages/CategorySelectedAccountsPage.ets(165:23)");
                                    if (!isInitialRender) {
                                        Row.pop();
                                    }
                                    ViewStackProcessor.StopGetAccessRecording();
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("pages/CategorySelectedAccountsPage.ets(166:25)");
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("pages/CategorySelectedAccountsPage.ets(169:25)");
                                    Text.fontColor({ "id": 16777249, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                                    Text.fontSize('10vp');
                                    if (!isInitialRender) {
                                        Text.pop();
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Blank.create();
                                    Blank.debugLine("pages/CategorySelectedAccountsPage.ets(176:21)");
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("pages/CategorySelectedAccountsPage.ets(180:23)");
                                    Text.fontSize({ "id": 16777239, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
