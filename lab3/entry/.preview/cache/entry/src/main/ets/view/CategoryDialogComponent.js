...
export class CategoryDialogComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("view/CategoryDialogComponent.ets(25:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/CategoryDialogComponent.ets(26:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Scroll.debugLine("view/CategoryDialogComponent.ets(33:7)");
            if (!isInitialRender) {
                Scroll.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("view/CategoryDialogComponent.ets(34:9)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('支出');
            Text.debugLine("view/CategoryDialogComponent.ets(35:11)");
            Text.fontSize(20);
            Text.width("40%");
            Text.height('10%');
            Text.padding(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Grid.create();
            Grid.debugLine("view/CategoryDialogComponent.ets(42:11)");
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        GridItem.debugLine("view/CategoryDialogComponent.ets(44:15)");
                        if (!isInitialRender) {
                            GridItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Column.create();
                            Column.debugLine("view/CategoryDialogComponent.ets(45:17)");
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Image.debugLine("view/CategoryDialogComponent.ets(46:19)");
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("view/CategoryDialogComponent.ets(50:19)");
                            Text.fontSize('10vp');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('收入');
            Text.debugLine("view/CategoryDialogComponent.ets(73:11)");
            Text.fontSize(20);
            Text.width("40%");
            Text.height('10%');
            Text.padding(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Grid.create();
            Grid.debugLine("view/CategoryDialogComponent.ets(79:11)");
            Grid.columnsTemplate(this.PayGridLength);
            Grid.rowsTemplate(this.PayGridLength);
            Grid.width('100%');
            Grid.height('30%');
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        GridItem.create(deepRenderFunction, isLazyCreate);
                        GridItem.debugLine("view/CategoryDialogComponent.ets(81:15)");
                        if (!isInitialRender) {
                            GridItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Column.create();
                            Column.debugLine("view/CategoryDialogComponent.ets(82:17)");
                            Column.width({ "id": 16777223, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                            Column.aspectRatio(CommonConstants.FULL_SIZE);
                            Column.padding({ top: { "id": 16777232, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
                            Column.margin({ top: { "id": 16777234, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" }, left: { "id": 16777232, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Image.create(this.curType === item.typeText ? item.iconSelected : item.icon);
                            Image.debugLine("view/CategoryDialogComponent.ets(83:19)");
                            Image.width({ "id": 16777242, "type": 10002, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                            Image.aspectRatio(CommonConstants.FULL_SIZE);
                            if (!isInitialRender) {
                                Image.pop();
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Text.create(item.typeText);
                            Text.debugLine("view/CategoryDialogComponent.ets(87:19)");
                            Text.fontSize('10vp');
                            Text.fontColor(this.curType === item.typeText ? Color.White : { "id": 16777251, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                            Text.margin({ top: '6vp' });
                            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("view/CategoryDialogComponent.ets(111:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/CategoryDialogComponent.ets(112:13)");
